      ...
      <section className="space-y-6 pb-12 pt-6 md:pb-16 md:pt-10 lg:py-32">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
            {locale === "en" ? "Welcome to My Personal Blog" : "Chào mừng đến với Blog cá nhân của tôi"}
          </h1>
          <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
            {locale === "en"
              ? "Sharing thoughts, ideas, and experiences about technology, design, and life."
              : "Chia sẻ suy nghĩ, ý tưởng và trải nghiệm về công nghệ, thiết kế và cuộc sống."}
          </p>
